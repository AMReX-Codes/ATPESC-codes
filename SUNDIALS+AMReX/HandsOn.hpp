 ...
 * -----------------------------------------------------------------------------
 * Hader file for SUNDIALS + AMReX 2D advection-diffusion example.
 * ---------------------------------------------------------------------------*/

#ifndef SUNDIALS_AMREX_EXAMPLE_H
#define SUNDIALS_AMREX_EXAMPLE_H
...
struct ProblemOpt
{
  ...
  int write_diag         = 1;      // Enable (>0) diagnostics output
