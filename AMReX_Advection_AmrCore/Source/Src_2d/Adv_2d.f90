...
subroutine advect(time, lo, hi, &
     &            phi_old, phi_old_lo, phi_old_hi, &
     &            phi_new, phi_new_lo, phi_new_hi, &
     &            vx  , vx_lo, vx_hi, &
     &            vy  , vy_lo, vy_hi, &
     &            flxx, fx_lo, fx_hi, &
     &            flxy, fy_lo, fy_hi, &
  ...
  integer, intent(in) :: phi_old_lo(2), phi_old_hi(2)
  integer, intent(in) :: phi_new_lo(2), phi_new_hi(2)
  ...
  real(amrex_real), intent(in   ) :: phi_old(phi_old_lo(1):phi_old_hi(1),phi_old_lo(2):phi_old_hi(2))
  real(amrex_real), intent(inout) :: phi_new(phi_new_lo(1):phi_new_hi(1),phi_new_lo(2):phi_new_hi(2))
