...
struct _N_VectorContent_Multifab {
  ...
  booleantype own_mf;  /* mf ownership flag */
  amrex::MultiFab *mf;
};
...
/*
 * -----------------------------------------------------------------
 * Macros NV_CONTENT_M, NV_OWN_MF_M,
 *        NV_LENGTH_M
 * -----------------------------------------------------------------
 */
...
/*
 * -----------------------------------------------------------------
 * Functions exported by nvector_multifab
 * -----------------------------------------------------------------
 */
...
SUNDIALS_EXPORT N_Vector N_VNew_Multifab(sunindextype vec_length,
                                         ...
                                         sunindextype nComp,
                                         sunindextype nGhost);
SUNDIALS_EXPORT N_Vector N_VMake_Multifab(sunindextype vec_length, amrex::MultiFab *mf);
...
SUNDIALS_EXPORT void N_VSpace_Multifab(N_Vector v, sunindextype *lrw, sunindextype *liw);

/* standard vector operations */
SUNDIALS_EXPORT void N_VLinearSum_Multifab(realtype a, N_Vector x, realtype b, N_Vector y, N_Vector z);
...
SUNDIALS_EXPORT realtype N_VWrmsNormMask_Multifab(N_Vector x, N_Vector w, N_Vector id);
...
SUNDIALS_EXPORT booleantype N_VConstrMask_Multifab(N_Vector c, N_Vector x, N_Vector m);
